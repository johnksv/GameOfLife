 ...
 * Conway's rule specifies the next generation with these requirement: A cell
 * survives on if it has two or three neigbhors. A cell will be born if it has
 * excatly three neigbhors. Otherwise the cell will die.
 *
